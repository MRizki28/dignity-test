                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('patients.create') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="birthdate" id="birthdate" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('birthdate') }}" >
                        </div>
